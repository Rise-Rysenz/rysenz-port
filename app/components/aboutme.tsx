...
export default function App() {
    ...
    return (
        <div className="flex flex-col w-full h-fit p-5 text-center gap-5">
            ...
            <div className=" flex flex-col justify-center justify-items-center content-center text-center gap-4">
                ...
                <motion.div 
                  className=" grid grid-cols-2 w-full justify-start items-start h-full overflow-hidden"
                ...
                >
                    <div className=" text-start flex flex-col gap-2">
                        <section>
                            <h1 className=" font-bold text-3xl p-2 bg-purple-400 w-fit">Why I'm be the Minecraft freelancer?</h1>
                    ...
                    <div className=" text-start flex flex-col gap-6"> 
                        <h1 className=" font-bold text-3xl p-2 bg-purple-400 w-fit">My works timeline</h1>
                        <div className=" flex flex-row gap-4">
                            <div className=" flex flex-col">
                                <div className=" rounded-full w-5 h-5 mt-1  bg-[#464646]"/>
                                <div className=" rounded-full w-5 h-5 mt-12 bg-[#464646]"/>
                                <div className=" rounded-full w-5 h-5 mt-4.5 bg-[#464646]"/>
                                <div className=" rounded-full w-5 h-5 mt-5 bg-[#464646]"/>
                                <div className=" rounded-full w-5 h-5 mt-11.5 bg-[#464646]"/>
                                <div className=" rounded-full w-5 h-5 mt-12 bg-[#464646]"/>
                                <div className=" rounded-full w-5 h-5 mt-9 bg-[#464646]"/>
                            </div>
                            <section className=" flex flex-col text-start content-center items-start gap-4">
                ...
                <section className=" flex flex-col gap-4 justify-center justify-items-center items-center">
                    <h1 className=" mt-6 text-2xl">My current project: <span className="bg-gradient-to-r bg-clip-text text-transparent from-lime-300 to-yellow-400 p-2 font-bold">CustomCrops Bedrock Add-on</span></h1>
                    <p className=" text-xl">Video</p>
                    <div className=" w-[32rem] h-80 bg-[#464646] rounded-lg text-center items-center content-center">
                        <p>Not Yet</p>
                    </div>
                </section>
